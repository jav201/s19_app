...
| P-5 | H-2: *"make the ceiling ATs compare against an independently derived bound"* | ❌ **REJECTED on measurement** | a per-term-sound independent derivation is **3.07–2.50×** the product value at decision time, **2.29–2.01×** re-derived on `fd9124a` after Option 3 raised the product side (both refs stated per C-39); adopting it as the ceiling would have doubled-to-tripled the bound and weakened all 7 ceiling ATs. Sandwiched the constant instead |
