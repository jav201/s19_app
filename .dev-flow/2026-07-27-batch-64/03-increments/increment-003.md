...
- `.dev-flow/2026-07-27-batch-64/01-requirements.md` — §9d (A-41…A-46) and the eight body corrections
  above (+148 / −5).

`.dev-flow/2026-07-27-batch-64/03-increments/increment-003.md` is this packet, not counted, per the
...
1. **`.dev-flow/BACKLOG-CODE.md` and `.dev-flow/2026-07-27-batch-64/PLAN.md` are NOT written, and that
