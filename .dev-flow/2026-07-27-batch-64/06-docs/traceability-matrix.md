...
**Branch** `claude/batch-64-addendum-producer-bound` · **base** `082ada9` · **HEAD** `ba5f09a`.
**Source of this mapping:** `REQUIREMENTS.md` §`R-TUI-098` (the shipped entry) and
`.dev-flow/2026-07-27-batch-64/04-validation.md` §1–§3. Nothing below is re-derived from memory.
